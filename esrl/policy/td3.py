...
class P3STD3Policy(DDPGPolicy):
    ...
    def learn(self,best_actor: Any,action_shape:Any, batch: Batch, **kwargs: Any) -> Dict[str, float]:
        # critic 1&2
        ...
        if self._cnt % self._freq == 0:
            actor_loss = (-self.critic1(batch.obs, self(batch, eps=0.0).act) + 0.5 * KL).mean()
