...
from esrl.util import MultipleLRSchedulers
...
class BasePolicy(ABC, nn.Module):
    ...
    * :meth:`~tianshou.policy.BasePolicy.update`: the main interface for training, \
    ...
    def update(self,best_actor: Any,action_shape: Any, sample_size: int, buffer: Optional[ReplayBuffer],
        ...
        result = self.learn(best_actor,action_shape, batch, **kwargs)
